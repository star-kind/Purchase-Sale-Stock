...
<!-- Morris chart -->
<link rel="stylesheet"
	href="${basePath}/AdminLTE/bower_components/morris.js/morris.css">
<!-- jvectormap -->
<link rel="stylesheet"
	href="${basePath}/AdminLTE/bower_components/jvectormap/jquery-jvectormap.css">
<!-- Date Picker -->
<link rel="stylesheet"
	href="${basePath}/AdminLTE/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
<!-- Daterange picker -->
<link rel="stylesheet"
	href="${basePath}/AdminLTE/bower_components/bootstrap-daterangepicker/daterangepicker.css">
<!-- bootstrap wysihtml5 - text editor -->
<link rel="stylesheet"
	href="${basePath}/AdminLTE/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
...
<body class="hold-transition skin-blue sidebar-mini">
							...
							<ul class="dropdown-menu">
								...
								<li>
									...
									<ul class="menu">
										...
										<li><a href="#">
												<div class="pull-left">
													<img src="${basePath}/AdminLTE/dist/img/user3-128x128.jpg"
														class="img-circle" alt="User Image">
												</div>
												<h4>
										...
										<li><a href="#">
												<div class="pull-left">
													<img src="${basePath}/AdminLTE/dist/img/user4-128x128.jpg"
														class="img-circle" alt="User Image">
												</div>
												<h4>
	...
	<!-- jQuery UI 1.11.4 -->
	<script
		src="${basePath}/AdminLTE/bower_components/jquery-ui/jquery-ui.min.js"></script>
	...
	<!-- Morris.js charts -->
	<script
		src="${basePath}/AdminLTE/bower_components/raphael/raphael.min.js"></script>
	<script
		src="${basePath}/AdminLTE/bower_components/morris.js/morris.min.js"></script>
	<!-- Sparkline -->
	<script
		src="${basePath}/AdminLTE/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
	<!-- jvectormap -->
	<script
		src="${basePath}/AdminLTE/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
	<script
		src="${basePath}/AdminLTE/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
	<!-- jQuery Knob Chart -->
	<script
		src="${basePath}/AdminLTE/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
	<!-- daterangepicker -->
	<script
		src="${basePath}/AdminLTE/bower_components/moment/min/moment.min.js"></script>
	<script
		src="${basePath}/AdminLTE/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
	<!-- datepicker -->
	<script
		src="${basePath}/AdminLTE/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
	<!-- Bootstrap WYSIHTML5 -->
	<script
		src="${basePath}/AdminLTE/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
	<!-- Slimscroll -->
	<script
	...
	<script src="${basePath}/AdminLTE/dist/js/pages/dashboard.js"></script>
