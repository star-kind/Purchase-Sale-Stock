...
<!-- DataTables -->
<link rel="stylesheet"
	href="${basePath}/AdminLTE/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
<!-- Theme style -->
<link rel="stylesheet"
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li><a href="/stocker-manager/StockController/SubQueue"> <i
							class="fa fa-envelope"></i> <span>入库申请</span> <span
							class="pull-right-container"> <small
								class="label pull-right bg-yellow len_amount"></small> <!-- <small
